...
<div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between ">
    <div class="flex">
        <h2 class="uppercase text-xl p-2 font-bold">Data Guru</h2> 
    </div>
            ...
            <div class="relative p-4 w-full max-w-3xl max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow-sm ">
                    ...
                    <div class="p-4 md:p-5">
                      <form class="space-y-4" action="{{ route('guru.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        ...
                        <div>
                            ...
                            <input type="number" name="nuptk"  id="nuptk" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
                            @error('nuptk')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="mapel" id="mapel" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
                            @error('mapel')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
      ...
      <tbody>
        @foreach ($gurus as $guru)      
          <tr class="bg-white border-b  hover:bg-gray-50 ">
              ...
              <td class="px-6 py-4">
                {{$guru->tempatlahir}},   
                {{ $guru->tanggallahir->format('d-m-Y')}}
              </td>
              <td class="px-6 py-4">
                {{$guru->alamat}}   
              </td>
              <td class="px-6 py-4">
                <img src="{{ asset('/storage/foto/' . $guru->fotoguru) }}" width="50px"> 
              </td>
                ...
                <div id="edit-modal-{{ $guru->id }}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                  <div class="relative p-4 w-full max-w-3xl max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow-sm ">
                        ...
                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t border-gray-200">
                            <h3 class="text-xl font-semibold text-gray-900 ">
                              Edit Data Guru {{$guru->nama_lengkap}}
                            </h3>
                        ...
                        <div class="p-4 md:p-5">
                          <form class="space-y-4" action="{{ url('admin/guru/'. $guru->id.'/update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div>
                                <label for="nama_lengkap" class="block mb-2 text-sm font-medium text-gray-900">Nama Lengkap</label>
                                <input type="text" name="nama_lengkap" value="{{$guru->nama_lengkap}}" id="nama_lengkap" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
                                @error('nama_lengkap')
                                    <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                          ...
                          <div class="p-3">
                            <svg class="mx-auto mb-2 text-gray-400 w-12 h-12 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                               <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 11V6m0 8h.01M19 10a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
                                ...
                                <h2 class="font-semibold text-lg mb-2 text-dark">Yakin Ingin Hapus <b>{{$guru->nama_lengkap}}</b> ?</h2>    
